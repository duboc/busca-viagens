...
export default function Skeleton({
  ...
  if (variant === 'card') {
    return (
      <div
        className={`bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4 animate-pulse ${className}`}
        style={{ width, height }}
      >
        ...
        <div className="mt-4 flex items-center gap-4">
          <div className="space-y-1.5 text-center">
            ...
            <div className="h-2 w-8 bg-gray-200 dark:bg-gray-700 rounded mx-auto" />
          </div>
